...
```{r q8b-hint}
# Group by the 'continent' column to aggregate data by continental regions
```
...
Finally, let's visualize the participant data on a world map:
...
```{r q8c-exercise, exercise=TRUE, exercise.setup="q8c-setup"}
